...
1. Crie um arquivo chamado `docker-compose.yml` em uma pasta vazia no seu computador.
...
3. Abra o terminal na mesma pasta onde salvou o arquivo e execute o comando:

docker compose up -d

### Acesso à Aplicação

O Docker irá baixar as imagens diretamente do Docker Hub e subir a aplicação:

- **Front-end:** Abra o navegador e vá para http://localhost
- **API (Back-end):** Disponível em http://localhost:8080

Para derrubar os containers após o uso, execute:
